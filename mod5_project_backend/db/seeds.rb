...
large_hp_potion = Item.create(name:"Large HP Potion", effect: "Recover 1000 HP", key: "hp", icon_name: "large_HP", rarity: 1, status: 1000, cooldown: 5000)
atk_damage_potion = Item.create(name:"Attack Damage Potion", effect: "Add 100 Atk", key: "atk_boost", icon_name: "atk_potion", rarity: 3, status: 100, cooldown: 10000)
